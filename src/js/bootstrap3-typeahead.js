...
(function(root, factory) {
  ...
  * ================================= */
  ...
  , highlighter: function (item) {
          var html = $('<div></div>').html(item.html);
          var text = item.text;
          ...
          len = query.length;
          if (len == 0){
              return html.html(item.html).html();
          }
          var textHtml = $('<span />');
          while (i > -1) {
          ...
          textHtml.append(document.createTextNode(text));
          html.find('[data-target=text]').replaceWith(textHtml);
          return html.html();
    }
  ...
  , render: function (items) {
      ...
      items = $(items).map(function (i, item) {
        i = $(that.options.item).data('value', item.text);
